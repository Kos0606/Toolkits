//Exercises
// These exercises can be solved using only the tools in the toolkit described above. For the
// moment, stick to just that set of tools.
...
// one star to it before we log the value of row. Starting again with this idea might give
...
// the value of a variable. Here is an example where the numberOfRows is equal to 10.
...
// the sum of each individual index value from the given arrays. Sample array :
...
//10. Use the following array with your solution to Exercise 8. How can you avoid an error
...
// element is smaller than the second, swap the two values. Next compare the second
...
// 13. How would you extend your solution to 13 to repeat this swapping of elements so that
// the entire array is sorted with the largest element at index 0 and the smallest element
// at the last index.
...
// 14. How would you change your solution to exercise 13 so that the array was sorted in the
// opposite order with the smallest element in index 0 and the largest element in the last
// index?
